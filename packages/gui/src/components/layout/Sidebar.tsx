...
export function Sidebar() {
  ...
  return (
    <aside className="w-16 bg-[var(--bg-elevated)] border-r border-[var(--border)] flex flex-col items-center py-4 gap-2">
      {navItems.map((item) => {
      ...
      <motion.div
        className="p-3 rounded-xl bg-[var(--accent)]/10 text-[var(--accent)]"
